...
<h2>notifications-system-volume</h2>
...
<p><b>Valid values</b>:</p>
<ul>
<li>always - always show a notification when the current track changes;</li>
<li>interaction - show a notification when the current track changes but only if it's explicitly done by the user;</li>
<li>never - never show a notification when the current track changes;</li>
</ul>
<p><b>Default</b>: always</p>

<hr id="notifications-track-volume">
<h2>notifications-track-volume</h2>
